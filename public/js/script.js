...
inviteButton.addEventListener("click", (e) => {
  // if(prompt("Send this link to the people you want to meet with:",window.location.href)){
...
socket.on("createMessage", (message, userName) => {
  messages.innerHTML =
    ...
    document.querySelector('.main__chat_window').scrollTop = document.querySelector('.main__chat_window').scrollHeight;
});
...
window.addEventListener('beforeunload', function(){
  ...
  socket.close();
  socket.local.disconnectSockets();
});
